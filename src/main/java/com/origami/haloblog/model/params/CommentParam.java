...
/**
 * @author origami1203
 * @date 2020-12-12 19:54
 * @description Comment的验证参数
 */
@Data
public abstract class CommentParam<Comment> implements DTOToEntity<Comment> {
    ...
    public ParameterizedType getParameterizedType() {
        return BeanUtils.getParameterizedType(CommentParam.class, this.getClass().getSuperclass());
    }
